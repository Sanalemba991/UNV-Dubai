const id = "feature-1.md";
						...
						const body = "";
						const data = {id:1,title:"Digital Link Technology",body:"Welcome to Digital Link Technology, Dubai's premier distributor of UNV and Dahua CCTV cameras. Our mission is to provide you with unparalleled security solutions, from state-of-the-art surveillance systems to comprehensive security packages. Trust in our expertise to safeguard your premises and ensure peace of mind.",icon:"../icons/unvicon.svg"};
						const _internal = {
							type: 'content',

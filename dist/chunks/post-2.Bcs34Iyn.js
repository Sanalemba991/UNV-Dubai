const id = "post-2.md";
					...
					,authorImageAlt:"Avatar Description",pubDate:new Date(1707523200000),cardImage:
						new Proxy({"src":"/_astro/Uniview.BP5e-7G1.avif","width":1200,"height":960,"format":"avif","fsPath":"C:/Users/sanalemba/UNV-Dubai/src/assets/images/blogs/Uniview.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/sanalemba/UNV-Dubai/src/assets/images/blogs/Uniview.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("C:/Users/sanalemba/UNV-Dubai/src/assets/images/blogs/Uniview.avif");
							return target[name];
						}
					})
					,cardImageAlt:"UNV distribution in Dubai",readTime:5,tags:["safety","security","management"]};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/sanalemba/UNV-Dubai/src/content/blog/post-2.md",
							rawData: undefined,
						};
